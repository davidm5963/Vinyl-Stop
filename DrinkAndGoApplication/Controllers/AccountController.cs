...
namespace VinylStop.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [Authorize]
        public async Task<ActionResult> MyAccount(MyAccountViewModel myAccountViewModel)
        {
            ...
            myAccountViewModel = new MyAccountViewModel
            {
                ...
                OrderHistory = _orderRepository.OrdersByCustomerId(user?.Id).ToList(),
                OrderLines = _orderRepository.GetOrderLines(_orderRepository.OrdersByCustomerId(user?.Id))
            };
        ...
        public ActionResult AllAccounts() => View();
